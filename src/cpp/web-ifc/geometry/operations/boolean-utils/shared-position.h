    ...
    */
    ...
    struct SharedPosition
    {
        ...
        void Construct(const Geometry &A, const Geometry &B, const BVH &bvhA, const BVH &bvhB, bool isUnion)
        {
            ...
            AddGeometry(A, B, bvhB, boxB, true, isUnion, 0);
            AddGeometry(B, A, bvhA, boxA, false, isUnion, A.planes.size());
        ...
        void AddGeometry(const Geometry &geom, const Geometry &secondGeom, const BVH &secondBVH, const AABB &relevantBounds, bool isA, bool isUnion, uint32_t offsetPlane)
        {
