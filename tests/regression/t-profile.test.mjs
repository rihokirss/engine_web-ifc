...
const source=fs.readFileSync(new URL('./geometry-fixtures/ifc4-t-profile.ifc',import.meta.url),'utf8');
...
test('t-profile: different flange and web thickness',async()=>check(source,18));
